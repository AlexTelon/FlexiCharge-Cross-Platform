    ...
    void _showAlertDialog(BuildContext context) {
      showCupertinoModalPopup<void>(
        ...
        builder: (BuildContext context) => CupertinoAlertDialog(
          ...
          content: const Text(
              'Are you sure you want to delete your Flexicharge user account?'),
            ...
            children: <Widget>[
              ...
              Container(
                ...
                child: TextInputWidget(
                    ...
                    onChanged: (value) => model.updateMobileNumber(value)),
              ),
              Container(
              ...
              Container(
                padding: EdgeInsets.only(
                    bottom: screenHeight * (desiredPercentage / 100)),
              ),
              Container(
